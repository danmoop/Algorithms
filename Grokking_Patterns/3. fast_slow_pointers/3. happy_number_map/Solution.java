...
public class Solution {
    ...
    */
    ...
    private static void solve() {
        ...
        println(isHappyNumber(n, map));
    }

    private static boolean isHappyNumber(int n, Map<Integer, Boolean> map) {
        int sum = 0;
        int t = n;
        ...
        if (map.getOrDefault(sum, false)) return false;
        if (sum == 1) return true;
        map.put(sum, true);

        return isHappyNumber(sum, map);
    }
